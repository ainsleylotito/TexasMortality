...
The ARIMA estimated an immediate increase in **6.95 deaths** and  an estimated reduction of **-2.30 deaths** each month after Bill 8 was enacted. 

Finally, we can run a counter-factual model in which we forecast deaths for 2021-2023 given the model parameters from our initial model, minus the step and ramp parameters. 
...
The ARIMA estimated an immediate increase in **45.66 deaths** and  an estimated reduction of **-1.5 deaths** each month after Bill 8 was enacted. 

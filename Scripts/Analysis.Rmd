...
monthly_m %>% #checking which months are missing in the female df
  ...
  select(month_year)
```
We have combined the datasets, but it should be noted we are missing death data for females for May 2019 (2019-05-01) and September 2019 (2019-09-01). We need to fill in this hole, so we will investigate filling this gap in the data by querying both genders and subtracting the deaths for males to reveal how many were among females. 

...
#keeping only shared dates 
combined_racial <- racial %>%
  inner_join(
    racial_covid,
    by = c("month_year", "race_eth"),
...
all_cause_minus_covid <- combined %>%
  ...
  select(month_year, race_eth, Deaths)
...
#keeping only shared dates 
combined_racial <- racial %>%
  inner_join(racial_covid, by = c("month_year", "race_eth"), suffix = c("_all", "_covid"))
